  ...
  // <script>
    ...
    AutoComplete.prototype = {
        ...
        renderDropdown: function () {
            return '<input type = "text" value ="Hi There"><ul class="rte-autocomplete dropdown-menu"><li class="loading"></li></ul>';
        },

        render: function (item, index) {
            return '<li>' +
                        '<input type = "text" value ="Hi There"><a href="javascript:;"><span>' + item[this.options.queryBy] + '</span></a>' +
                    '</li>';
        },
